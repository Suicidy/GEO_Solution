...
$sql = "SELECT  course.course_id,teacher_id,subject,topic,date(start_time) as date, DATE_FORMAT(start_time,'%H:%i') start_time,DATE_FORMAT(end_time,'%H:%i') end_time,room,countSeat
