<?php include('header.php'); ?>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#select,#select2,#select3").change(function(){
				var obj = {};
				obj['TA'] = $("#select").val();
				obj['subject'] = $("#select2").val();
				$.ajax({
			...
			<div class="col">
				...
				<div class="form-group">
					<select class="form-control col-2" style="float:left;" id="select">
						<?php require "ta_info/option_teacher.php";?>					    
					</select>
					<select class="form-control col-2" style="float:left;" id="select2">
						<option value = "Choose_option">Choose...</option>
					    <option value = "MTH102_option">MTH102</option>
						<option value = "MTH112_option">MTH112</option>					    
					    <option value = "PHY102_option">PHY102</option>
						<option value = "PHY104_option">PHY104</option>
					    <option value = "CHM103_option">CHM103</option>				    
					</select>
				</div>
				<br>
				<br>
