	    ...
	    <div class="modal-dialog" role="document">
			<div class="modal-content">
	        	...
	        	<div class="modal-body">
					...
					<p><a href="/geo_solution/resource/account_recovery.php" class="tooltip-test">ลืมรหัสผ่าน</a> หรือ <a href="/geo_solution/resource/request_pass.php" class="tooltip-test">ขอรหัสผ่านครั้งแรก</a></p>
				</div>
