...
<head>
	...
	//     	//$("#nav-MTH_102-tab").addClass('active');
	//     	//getCourseMTH102('ทุกวัน');
	//     	console.log();
	//     	//console.log($("#nav-MTH_102-tab").hasClass("show"));
	//     	if ($(this).hasClass("active3")) {
	// 			$("#headMTH102").empty().append('eiei');
	//     	}
	//     	$("#headMTH102").empty().append($("#nav-MTH_102").hasClass("active")+'eiei');
	//     });
